...
TOOLTIPS = {
    ...
    'thread_thickness': "Толщина каждой нити при экспорте в PNG.\nНе влияет на скорость генерации.",
    'thread_scale': "Визуальный масштаб нитей в окне предпросмотра.\nНе влияет на скорость или экспорт.",
    ...
    'save_progress': "Сохранить текущее состояние для последующего возобновления.",
    'load_progress': "Загрузить ранее сохраненный прогресс."
}
